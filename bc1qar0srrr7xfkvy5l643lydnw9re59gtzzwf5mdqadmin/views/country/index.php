            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Все бренды</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/add-country" class="btn btn-success"><i class="fe fe-plus me-2"></i>
                                Добавить бренд</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Название</th>
                                            <th class="wd-15p border-bottom-0">Управление</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        if (isset($validCountry) && count($validCountry) > 0):
                                            $n = 1;
                                            foreach ($validCountry as $tmp):
                                                ?>
                                                <tr>
                                                    <td><span class="font-weight-normal1 fs-14"><?=$n?></span></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['name_ru']?></span></td>
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/country/delete/<?=$tmp['id']?>" class="btn btn-outline-danger">Удалить</a></td>
                                                    </tr>
                                                <?php
                                                $n++;
                                            endforeach;
