...
<head>
    ...
    <!-- INTERNAl Quill css -->
    <link href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/plugins/quill/quill.snow.css" rel="stylesheet">
    <link href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/plugins/quill/quill.bubble.css" rel="stylesheet">

    <!-- INTERNAl WYSIWYG Editor css -->
    <link href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/plugins/wysiwyag/richtext.css" rel="stylesheet" />
            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Добавить пост</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/blog-table" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                Все товары</a>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/blog/add-complete" enctype="multipart/form-data">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите автора<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="author" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите заголовок<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="title" type="text" required="required">
                                            </div>
                                        </div>

                                        <div class="col-lg-12 col-sm-12">
                                            <label class="form-label">Выберите фото для каталога (893х763) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="content" rows="20" name="fulldescription" placeholder="Описание..." required="required"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/plugins/wysiwyag/jquery.richtext.js"></script>
<script src="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/js/form-editor.js"></script>

<!-- INTERNAL quill js -->
<script src="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/plugins/quill/quill.min.js"></script>
<script src="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/template/assets/js/form-editor2.js"></script>
