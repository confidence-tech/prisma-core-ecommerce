            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Текстовые переменные</h4>
                    </div>
                </div>
                <!--End Page header-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Текст</th>
                                            <th class="wd-15p border-bottom-0">Опции</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        if (isset($res) && count($res) > 0):
                                            ...
                                            foreach ($res as $tmp):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['slug']?></span></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['text_val']?></span></td>
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/custom-text-edit/<?=$tmp['id']?>" class="btn btn-warning"><i class="ion-edit"></i> Изменить</a></td>
                                                </tr>
                                                <?php
                                                $n++;
                                            endforeach;
