        ...
        <div class="hor-content main-content">
            <div class="container">
                ...
                if (isset($translate) && !empty($translate)):
                    ?>
                    <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/translate-edit">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control mb-4" placeholder="..." value="<?=$translate['fulldescription_ru']?>" name="f_ru" type="text" required="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card">
                                    <div class=" card-body">
                                        <input type="submit" name="send" class="btn btn-outline-success float-end" value="Отредактировать">
                                    </div>
                                </div>
                            </div>
                        </div>
