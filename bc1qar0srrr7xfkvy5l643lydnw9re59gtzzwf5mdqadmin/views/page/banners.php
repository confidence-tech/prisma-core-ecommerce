            ...
            <div class="container">
                ...
                <div class="page-header">
                    ...
                    <div class="page-rightheader">
                        <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/banner/add" class="btn btn-success">Добавить банер</a>
                    </div>
                </div>
                <!--End Page header-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Ссылка</th>
                                        ...
                                        if (isset($res) && count($res) > 0):
                                            ...
                                            foreach ($res as $tmp):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="/assets/banners/<?=$tmp['photo']?>" width="220px"></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['url']?></span></td>
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/banner-delete/<?=$tmp['id']?>" class="btn btn-lg btn-danger"><i class="ion-trash-a"></i></a></td>
                                                </tr>
                                                <?php
                                                $n++;
                                            endforeach;
