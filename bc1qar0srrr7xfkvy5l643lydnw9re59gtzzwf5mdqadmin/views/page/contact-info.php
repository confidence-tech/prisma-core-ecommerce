            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Редактирование контактной информации</h4>
                    </div>
                </div>
                <!--End Page header-->


                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/contact/edit/success">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-4" placeholder="..." name="email" value="<?=$res['email']?>" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Адресс <span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="adress" value="<?=$res['adress']?>" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Телефон 1 <span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="phone_1" value="<?=$res['phone_1']?>" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Телефон 2 <span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="phone_2" value="<?=$res['phone_2']?>" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
