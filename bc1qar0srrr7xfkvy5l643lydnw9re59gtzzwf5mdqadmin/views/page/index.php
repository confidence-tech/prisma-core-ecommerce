            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Все страницы / СЕО</h4>
                    </div>
                </div>
                <!--End Page header-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Редактировать</th>
                                            <th class="wd-15p border-bottom-0">Название страницы RU</th>
                                            <th class="wd-15p border-bottom-0">Meta Title RU</th>
                                            <th class="wd-15p border-bottom-0">Meta Keywords RU</th>
                                            <th class="wd-15p border-bottom-0">Meta Description RU</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        if (isset($res) && count($res) > 0):
                                            ...
                                            foreach ($res as $tmp):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page/edit/<?=$tmp['id']?>" class="btn btn-outline-success"><i class="ion-edit"></i> ИЗМЕНИТЬ</a></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['title_ru']?></span></td>
                                                    <td><span class="fs-14"><?=$tmp['meta_title_ru']?></span></td>
                                                    <td><span class="fs-14"><?=$tmp['meta_keywords_ru']?></span></td>
                                                    <td><span class="fs-14"><?=$tmp['meta_decription_ru']?></span></td>
                                                    </tr>
                                                <?php
                                                $n++;
                                            endforeach;
