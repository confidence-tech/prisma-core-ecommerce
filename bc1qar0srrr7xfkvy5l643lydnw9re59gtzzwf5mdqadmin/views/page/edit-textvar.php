            ...
            <div class="container">
                ...
                <div class="page-header">
                    ...
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/custom-text" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                Все переменные</a>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/text/edit-success">
                    <input type="hidden" name="id" value="<?=$id_var?>">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class=" card-body">
                                    <div class="form-group">
                                        <label class="form-label">Текст<span class="text-danger">*</span></label>
                                        <textarea class="content" rows="20" name="text"><?=$res['text_val']?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
