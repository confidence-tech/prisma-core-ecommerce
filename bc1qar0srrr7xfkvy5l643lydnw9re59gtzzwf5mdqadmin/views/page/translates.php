            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Переводы для страниц</h4>
                    </div>
                </div>
                <!--End Page header-->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Идентификатор</th>
                                            <th class="wd-15p border-bottom-0">Значение</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        if (isset($translates) && count($translates) > 0):
                                            ...
                                            foreach ($translates as $tmp):
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/translate/edit/<?=$tmp['id']?>" class="btn btn-outline-success"><i class="ion-edit"></i></a></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['name']?></span></td>
                                                    <td><span class="font-weight-normal2 fs-14"><?=$tmp['fulldescription_ru']?></span></td>
                                                </tr>
                                                <?php
                                                $n++;
                                            endforeach;
