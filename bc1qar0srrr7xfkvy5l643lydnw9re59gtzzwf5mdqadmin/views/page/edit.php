            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Редактирование СЕО данных страницы</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page/constructor" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                СЕО страниц</a>
                        </div>
                    </div>
                </div>
                ...
                ?>
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page/edit/success" enctype="multipart/form-data">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите TITLE страницы<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." value="<?=$res['title_ru']?>" name="title_ru" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите META-TITLE страницы<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." value="<?=$res['title_ru']?>" name="meta_title_ru" type="text" required="required">
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class=" card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите META-DESCRIPTION страницы<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="Meta Description" value="<?=$res['meta_decription_ru']?>" name="meta_description_ru" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Введите META-KEYWORDS страницы<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="Meta Keywords" value="<?=$res['meta_keywords_ru']?>" name="meta_keywords_ru" type="text" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card">
                                <div class=" card-body">
                                    <input type="submit" class="btn btn-outline-success float-end" value="Отредактировать">
                                </div>
                            </div>
                        </div>
                    </div>
