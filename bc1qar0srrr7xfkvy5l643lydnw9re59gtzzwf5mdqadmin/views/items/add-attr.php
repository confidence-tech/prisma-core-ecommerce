            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Добавить атрибут</h4>
                    </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/attr/add/success">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Введите название атрибута<span class="text-danger">*</span></label>
                                                <input class="form-control mb-4" placeholder="..." name="name" type="text" required="required">
                                            </div>
                                        </div>
                                                ...
                                                <select name="category" class="form-control custom-select select2">
                                                    ...
                                                    if (isset($category) && !empty($category)){
                                                        foreach ($category as $tmp){
                                                            ?>
                                                            <option value="<?=$tmp['id']?>"><?=$tmp['type_ru']?></option>
                                                            <?php
                                                        }
                                                    }else{
                                                        ?>
