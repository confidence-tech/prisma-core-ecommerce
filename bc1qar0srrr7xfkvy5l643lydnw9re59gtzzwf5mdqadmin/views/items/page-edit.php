            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Конструктор Azurin</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page-azurin" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                Все страницы</a>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page/conf">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class=" card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control mb-4" placeholder="" value="<?=$page['page_name']?>" name="name" type="text" required="required">
                                        <input value="<?=$page['id']?>" name="id" type="hidden" required="required">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Страница сайта<span class="text-danger">*</span></label>
                                        <textarea class="content" rows="20" name="fulldescription"><?=$page['fulldescription']?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
