                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <th class="wd-20p border-bottom-0">Название Атрибута</th>
                                        ...
                                        if (isset($attr) && count($attr) > 0){
                                            ...
                                            foreach ($attr as $tmp){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$tmp['type']?></td>
                                                    <td>
                                                        <a style="margin-top: 5px" href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/del/attr/<?=$tmp['id']?>" type="button" class="btn btn-danger"><i class="fe fe-trash"></i> Удалить</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $n++;
