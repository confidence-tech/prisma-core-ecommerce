            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Атрибуты товара</h4>
                    </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/attr/product/edit">
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <?php if (!empty($attr)): ?>
                                            <?php $n = 0; ?>
                                            <?php foreach ($attr as $itm): ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label"><?=$itm['type']?> <span class="text-danger">*</span></label>
                                                        <input type="hidden" name="attr_id_<?=$n?>" value="<?=$itm['id']?>">
                                                        <?php $atr = Main_model::getForIItemAttr($itm['id'], $id_item) ?>
                                                        <input class="form-control mb-4" value="<?php if (isset($atr['value']) && !empty($atr['value'])){ echo $atr['value']; }?>" placeholder="..." name="attr_val_<?=$n?>" type="text" required="required">
                                                    </div>
                                                </div>
                                                <?php $n++; ?>
                                            <?php endforeach; ?>
