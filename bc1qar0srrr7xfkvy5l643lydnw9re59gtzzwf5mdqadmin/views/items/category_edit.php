            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Редактирование категории</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/category" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                Все категории</a>
                        </div>
                    </div>
                </div>
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/category/edit/success">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control mb-4" placeholder="..." name="name_ru" value="<?=$result['type_ru']?>" type="text" required="required">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="gender">
                                                    <?php if ($result['is_man'] == 1): ?>
                                                        <option selected value="1">Мужское</option>
                                                        <option value="2">Женское</option>
                                                    <?php else: ?>
                                                        <option value="1">Мужское</option>
                                                        <option selected value="2">Женское</option>
                                                    <?php endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="form-label">Акссессуар <span class="text-danger">*</span></label>
                                                <select class="form-control" name="access">
                                                    <?php if ($result['is_accessorize'] == 1): ?>
