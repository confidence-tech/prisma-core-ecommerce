            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Добавление цвета</h4>
                    </div>
                    <div class="page-rightheader">
                        <div class="btn-list">
                            <a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/colors" class="btn btn-azure"><i class="ion-android-arrow-back me-2"></i>
                                Все цвета</a>
                        </div>
                    </div>
                </div>
                <!--End Page header-->
                    ...
                    <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/colors/add/success" enctype="multipart/form-data">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label">Название EN <span class="text-danger">*</span></label>
                                                    <input class="form-control mb-4" placeholder="..." name="name_en" type="text" required="required">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label">Название RU <span class="text-danger">*</span></label>
                                                    <input class="form-control mb-4" placeholder="..." name="name_ru" type="text" required="required">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label">Название SP <span class="text-danger">*</span></label>
                                                    <input class="form-control mb-4" placeholder="..." name="name_sp" type="text" required="required">
                                                </div>
                                            </div>
