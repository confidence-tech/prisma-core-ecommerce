            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Редактор дополнительных страниц</h4>
                    </div>
                </div>
                <!--End Page header-->
                                        ...
                                        if (isset($page) && count($page) > 0){
                                            ...
                                            foreach ($page as $tmp){
                                                ...
                                                <tr>
                                                    <td><?=$n?></td>
                                                    <td><?=$tmp['page_name']?></td>
                                                    <td><a href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/page/option/<?=$tmp['id']?>" type="button" class="btn btn-warning"><i class="fe fe-settings"></i> Изменить</a></td>
                                                </tr>
                                                <?php
                                                $n++;
                                            }
