            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-leftheader">
                        <h4 class="page-title mb-0 text-warning">Изменить фото(остальные)</h4>
                    </div>
                                    ...
                                    <table class="table table-bordered text-nowrap" id="example1">
                                        ...
                                        if (isset($photos) && count($photos) > 0){
                                            ...
                                            foreach ($photos as $tmp){
                                                ...
                                                <tr>
                                                    <td><?=$n?></td>
                                                    <td><div><img src="/assets/tovar/<?=$tmp['name_photo']?>" width="60px"></div></td>
                                                    <td>
                                                        <div class="p-3">
                                                            <a style="margin-top: 5px" href="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/item/current-photo-delete/<?=$tmp['id']?>" type="button" class="btn btn-danger">
                ...
                <form method="post" action="/bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdqadmin/add-photo-success" enctype="multipart/form-data">
                    <div class="row">
                                ...
                                <div class=" card-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12">
                                            ...
                                            <label class="form-label">Выберите фотографии <span class="text-danger">*</span></label>
