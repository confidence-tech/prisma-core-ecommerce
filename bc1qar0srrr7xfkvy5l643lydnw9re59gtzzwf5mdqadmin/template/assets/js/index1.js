$(function(e){
	...
	var options = {
		series: [{
		name: 'Расходы',
		data: [0, 42, 57, 86, 58, 55, 70, 52, 29,56, 75, 61],
		color:['#664dc9']
	  }, {
		name: 'Доходы',
	...
	var statistics1 = {
	  ...
	  var chart1 = new ApexCharts(document.querySelector("#statistics1"), statistics1);
	  chart1.render();
...
/* Apexcharts (#bar) */
	var statistics2 =  {
		series: [{
			name: 'Расходы',
			data: [0, 42, 57, 86, 58, 55, 70, 52, 29,56, 75, 61, 55, 70, 52, 29,56, 75, 61, 52, 29,56, 75, 61, 61],
			color:['#664dc9']
		}, {
			name: 'Доходы',
			data: [26, 35, 41, 78, 46, 37, 65, 49, 23, 38, 65, 27, 65, 49, 23, 38, 65, 27, 49, 23, 38, 65, 27, 27]
		}],
		chart: {
			type: 'area',
			height: 375
	  ...
	  var chart2 = new ApexCharts(document.querySelector("#statistics2"), statistics2);
	  chart2.render();
    ...
    var spark1 = {
		...
		series: [{
		  ...
		  name: 'Total Sales',
		  data: [22, 45, 54, 38, 56, 24, 65, 31, 37, 39, 62, 51, 35, 41, 35, 27, 93, 53, 61, 27, 54, 43, 19, 46]
		}],
		 yaxis: {
		  min: 0,
		  show: false
